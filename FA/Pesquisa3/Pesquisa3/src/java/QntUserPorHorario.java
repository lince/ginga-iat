 ...
 * @author Samuk
 */
public class QntUserPorHorario extends Window {

    private Flashchart mychart;
    private PieModel model;

//    public QntUserPorHorario() {
//        Calendar c1 = Calendar.getInstance();
//        Calendar c2 = Calendar.getInstance();
//
//        c1.setTime(new Date("11/10/1988 10:01:0"));
//        c2.setTime(new Date("11/10/1998 10:06:00"));
//
//        System.out.println(usuariosPorData(c1.getTime(), c2.getTime()));
//    }
...
//        QntUserPorHorario t = new QntUserPorHorario();
//    }
}
