 ...
 * @author Samuk
 */
public class QntUserPorHorarioProgram extends Window {
    ...
    public void update(Date inicio, Date fim, String programa) {
        Long usu = usuariosPorData(inicio, fim, programa);
    ...
    public Long usuariosPorData(Date inicio, Date fim, String program) {
        Configuration cfg = new Configuration().configure("/hibernateDW.cfg.xml");
        SessionFactory sf = cfg.buildSessionFactory();
        Session s = sf.openSession();
        Query qr = null;
        ...
        String sql = "SELECT COUNT(DISTINCT dimDevice.serialNumber)" +
                ...
                " IteractionHasDimData iteractionHasDimData, Iteraction iteraction, DimProgram dimProgram" +
                ...
                " AND dimProgram.name LIKE '" + program + "'";
