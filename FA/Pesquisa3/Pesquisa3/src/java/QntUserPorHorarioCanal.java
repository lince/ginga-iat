 ...
 * @author Samuk
 */
public class QntUserPorHorarioCanal extends Window {
    ...
    public void update(Date inicio, Date fim, String canal) {
        Long usu = usuariosPorData(inicio, fim, canal);
    ...
    public Long usuariosPorData(Date inicio, Date fim, String canal) {
        Configuration cfg = new Configuration().configure("/hibernateDW.cfg.xml");
        SessionFactory sf = cfg.buildSessionFactory();
        Session s = sf.openSession();
        Query qr = null;
