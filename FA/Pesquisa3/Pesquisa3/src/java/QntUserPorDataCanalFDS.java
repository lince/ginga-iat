 ...
 * @author Samuk
 */
public class QntUserPorDataCanalFDS extends Window {
    ...
    public List todosCanais() {
        ...
        Session s = sf.openSession();
        Query qr = null;
        String sql = "SELECT DISTINCT dimProgram.channelName" + " FROM DimProgram dimProgram" +
