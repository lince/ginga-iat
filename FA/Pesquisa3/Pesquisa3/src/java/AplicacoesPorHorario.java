 ...
 * @author Samuk
 */
public class AplicacoesPorHorario extends Window {
...
//            Label label = new Label(((DimMedia) ret.get(i)).getDocument());
            ...
            Label label2 = new Label((((QntAplicacoes) ret.get(i)).getQnt() / 2) + "");
